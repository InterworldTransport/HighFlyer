...
---com.interworldtransport.highflyer.SupportDialog-----------------------------------------
<p>
 ...
 */
    public SupportDialog(JPAUtility mainWindow, String pContent)
    {

	super(mainWindow, "Support for ISA Atmosphere Utility", true); //Use parent's constructor
